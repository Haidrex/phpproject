...
if (!isset($_SESSION['prev']) || ($_SESSION['prev'] != "register")) {header("Location: logout.php");exit;}
...
if (checkregname($user, $firstname, $lastname, $mail)) { // vardas  geras,  nuskaityti vartotoja is DB
    ...
    if ($dbuname) { // jau yra toks vartotojas DB
        ...
        { // viskas tinka sukurti vartotojo irasa DB
            ...
            $sql = "INSERT INTO " . TBL_USERS . " (vartotojo_id, slapyvardis, email, slaptazodis, vardas, pavarde, roles_id)
          VALUES ('$userid','$user', '$mail' ,'$pass', '$firstname','$lastname', '$ulevel')";
